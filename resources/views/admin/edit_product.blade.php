...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{url('admin_panel/products/update-product')}}/{{$product->product_id}}">
            @csrf
            @method('PUT')
          <div class="form-group row">
            <label for="name" class="col-sm-3 col-form-label">Product Name</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="name" name="name" placeholder="Product Name" value="{{$product->name}}" required autofocus>
              @if ($errors->has('name'))
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="description" name="description" placeholder="Product Description" value="{{$product->description}}" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="number" class="form-control" id="category_id" name="category_id" placeholder="Category Id" value="{{$product->category_id}}" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="image_url" name="image_url" placeholder="Image URL" value="{{$product->image_url}}" required>
